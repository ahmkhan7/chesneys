/// @description displays recipes on object and stores a list of available recipes
// You can write your code in this editor
unlocked_recipes = 0;
current_recipe = 0;
new_recipe = true;

recipe_list = [[obj_rcp_salad, "Salad"], [obj_rcp_sandwich, "Sandwich"], [obj_rcp_omelette, "Omlette"], 
